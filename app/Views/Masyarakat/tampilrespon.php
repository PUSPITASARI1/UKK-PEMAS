...
<textarea name="txtInputPengaduan" class="form-control" rows="5" id="comment" readonly><?=$detail[0]['tanggapan'];?>
</textarea>
</div>
...
<button class="btn btn-primary" onclick="goBack()">Kirim</button>
<script>
    function goBack() {
        window.history.back();
    }
