...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url(images/gambar1.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat Desa Cigarukgak</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<div class="form-group">
		      			<input name="txttelp" type="text" class="form-control" placeholder="Telp" required>
		      		</div>
	            <div class="form-group">
